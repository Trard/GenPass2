...
class MainUI(UI):
    ...
    first_frame = tk.Frame(master=main_frame)
    ...
    second_frame = tk.Frame(master=main_frame)
    ...
    def place(self):
        MainUI.main_frame.place(anchor=tk.CENTER, rely=0.4, relx=0.48125)
        MainUI.portal_savebox_button.pack(pady=2)
        MainUI.first_frame.pack()
        MainUI.portal_generatepas_button.pack(side=tk.LEFT, pady=2, padx=2)
        MainUI.portal_checkpas_button.pack(side=tk.LEFT, pady=2, padx=2)
        MainUI.second_frame.pack()
        MainUI.portal_aboutus_button.pack(side=tk.LEFT, pady=2, padx=2)
        MainUI.portal_settings_button.pack(side=tk.LEFT, pady=2, padx=2)
        MainUI.portal_leave_button.pack(side=tk.LEFT, pady=2, padx=2)
